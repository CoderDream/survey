...
public class MyTool {
	public int UpdateCol(String table, String col1, String val1, String col2, String val2) throws Exception {
	...
	public String getCo2(String table, String col1, String where) throws Exception {
		DBConnection db = null;
		Connection con = null;
		Statement stm = null;
		ResultSet rs = null;
