...
<body leftmargin="8" topmargin="8" background='/survey/view/skin/images/allbg.gif'>

<!--  快速转换位置按钮  -->
<table width="98%" border="0" cellpadding="0" cellspacing="1" bgcolor="#D1DDAA" align="center">
<tr>
 <td height="26" background="/survey/view/skin/images/newlinebg3.gif">
...
<tr bgcolor="#E7E7E7">
	<td height="24" colspan="10" background="/survey/view/skin/images/tbg.gif">&nbsp;内容列表&nbsp;</td>
</tr>
...
<td height="24" colspan="10" background="/survey/view/skin/images/tbg.gif">no data&nbsp;</td>
</tr>
<%}%>
<%
if(objList.size()>0){
